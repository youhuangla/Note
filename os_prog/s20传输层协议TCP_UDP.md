...
```shell
Transmission Control Protocol, Src Port: 7674, Dst Port: 80, Seq: 149, Ack: 2, Len: 0
    Sequence Number: 149    (relative sequence number) # sep = q
    Sequence Number (raw): 2883070301 # sep = q
...
如果使用这种模式，其实需要你和你的下属就不能靠脑⼦了，⽽是要都准备⼀个本子，你每交代下属⼀个事情，双方的本子都要记录⼀下。
